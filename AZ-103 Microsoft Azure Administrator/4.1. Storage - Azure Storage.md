...
- You can use physical drives
  ...
  - **Azure Databox**
    - Data Box Gateway, Azure Stack Edge are online products for data import
    - Microsoft ships physical [Data Box](https://azure.microsoft.com/en-us/services/databox/) storage device
    ...
    - Data Box Disk: 0 to 40TB, USB 3.0, only AES-128 bit encryption
    - Data Box: 40TB to 500 TB, 10 Gbps network interface
    - Data Box Heavy:  more than 500 TB - 1 PB , high-performance 40 Gbps interface
